...
class Polynomial:
  ...
  def area(self , a , b):
    ...
    return Integrated_Pol[b] - Integrated_Pol[a]
...
def approx():
    fx = Polynomial([0, 1, 1, 1 / 3, 0, -1 / 30, -1 / 90])
    ApproxArea = fx.area(0 , 0.5)
    ActualArea = fun_integral(0.5) - fun_integral(0)
    error = abs(ApproxArea - ActualArea)

    print("The computed area under the curve is:", ApproxArea)
    print("The actual area under the curve is:", ActualArea)
